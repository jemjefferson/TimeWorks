...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Break", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.EmployeeJobCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Hour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.JobCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Login", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Admin = true,
                            EmployeeID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAEL+NXKz+0Xcc1rkf7+07cxnh9bsFUVC6/8fVS+HySIFy7lArf3NiCKMbbY8Yc7N6+w==",
                        ...
                        new
                        {
                            ...
                            Admin = false,
                            EmployeeID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEJL7Mab8KpGw5+IU95aOwNHW83dfIIrji9DXhUyyuOope0SJmXS+uBPYxXBi5xZZ+w==",
                        ...
                        new
                        {
                            ...
                            Admin = false,
                            EmployeeID = 3,
                            PasswordHash = "AQAAAAEAACcQAAAAEFUstcTFIWT92cuClo2ImNjcPa7fqar5RotTDzNvGHoliDUNBc/4brCiY7rgS5y3yg==",
                            UserName = "jordanjefferson1"
                        });
                });

            modelBuilder.Entity("TimeWorks.DataAccess.PayPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Break", b =>
                {
                    b.HasOne("TimeWorks.DataAccess.Hour", "Hour")
                        .WithMany("Breaks")
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.EmployeeJobCode", b =>
                {
                    b.HasOne("TimeWorks.DataAccess.Employee", "Employee")
                        .WithMany("EmployeeJobCodes")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("TimeWorks.DataAccess.JobCode", "JobCode")
                        .WithMany("EmployeeJobCodes")
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Hour", b =>
                {
                    ...
                    b.HasOne("TimeWorks.DataAccess.EmployeeJobCode", "EmployeeJobCode")
                        .WithMany("Hours")
                        .HasForeignKey("EmployeeJobCodeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("TimeWorks.DataAccess.PayPeriod", "PayPeriod")
                        .WithMany("Hours")
            ...
            modelBuilder.Entity("TimeWorks.DataAccess.Login", b =>
                {
                    b.HasOne("TimeWorks.DataAccess.Employee", "Employee")
                        .WithOne("Login")
                        .HasForeignKey("TimeWorks.DataAccess.Login", "EmployeeID")
